...
def test_create_user(db_test) -> None:
    """Test create_user function."""

    user_data = UserCreate(
        name="John Doe", username="johndoe", password="securepassword123"
    )
...
def test_get_user_by_username(db_test) -> None:
...
def test_get_receipt_by_user_and_id(db_test) -> None:
